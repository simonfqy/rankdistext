...
RcppExport SEXP rankdistext_KendallNeighbour(SEXP rankSEXP) {
BEGIN_RCPP
...
RcppExport SEXP rankdistext_CayleyNeighbour(SEXP rankSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type rank(rankSEXP);
...
RcppExport SEXP rankdistext_LogC(SEXP faiSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
...
RcppExport SEXP rankdistext_CWeightGivenPi(SEXP r1SEXP, SEXP r2SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
...
RcppExport SEXP rankdistext_FindV(SEXP obsSEXP, SEXP pi0SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
...
RcppExport SEXP rankdistext_LogC_Component(SEXP faiSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type fai(faiSEXP);
...
RcppExport SEXP rankdistext_cycle_decomp(SEXP compSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type comp(compSEXP);
    __result = Rcpp::wrap(cycle_decomp(comp));
    return __result;
END_RCPP
}
// FindCayley
NumericVector FindCayley(NumericMatrix obs, NumericVector pi0);
RcppExport SEXP rankdistext_FindCayley(SEXP obsSEXP, SEXP pi0SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericMatrix >::type obs(obsSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type pi0(pi0SEXP);
    __result = Rcpp::wrap(FindCayley(obs, pi0));
    return __result;
END_RCPP
}
// Wtau
NumericMatrix Wtau(NumericMatrix obs, NumericVector pi0);
RcppExport SEXP rankdistext_Wtau(SEXP obsSEXP, SEXP pi0SEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericMatrix >::type obs(obsSEXP);
...
RcppExport SEXP rankdistext_AllPerms(SEXP nobjSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
